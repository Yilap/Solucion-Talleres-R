...
#####Elaboración Andrés
  ...
  #errores estándar
    ...
    matriz_Estimadores <- matrix(NA,nrow = 3,
                                 ncol = length(outcomes_nominales))
    
    for (i in 1:length(outcomes_nominales)){
    
    #Input
     
      # Función de estimación de betas y de errores estándar
    ...
    #Output
      ...
      matriz_Estimadores [i,2] <-  beta
      matriz_Estimadores [i,3] <-  error_est
      
      #colnames(matriz_Estimadores)[1] <- "Outcome"
      #colnames(matriz_Estimadores)[2] <- "Beta"
      #colnames(matriz_Estimadores)[3] <- "ee(Beta)"
    }
