...
### 1.9)	Programen una función que tome como input una matriz X estocástica de rango completo y un vector〖 y〗_i, posteriormente, el output debe corresponder a una estimación puntual del estimador (β_1) de Mínimos Cuadrados Ordinarios (MCO) para la muestra y a su error estándar asociado (σ_β). 
